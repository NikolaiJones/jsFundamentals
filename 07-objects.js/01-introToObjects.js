/*
    - just like arrays, objects are used to store multiple sets of data, and that data gets stored in a key/value format
...
// will attempt to console.log episode 4 (index 3)

let x = 4;
console.log(`Episode ${x} = ${netflix.season1.seasonInfo.episodeInfo[x -= 1].episodeName}`);

let myVar = `this is a string`;
console.log(`my variable myVar contains the string: ${myVar}`);
...
/*
    JSON OBJECTS
        ...
        - JSON exists as a string. JSON data is what we receive when we fetch data from a server. Since JSON is text only, it needs to be converted to a native JavaScript object if we want to be able to access and use the data
*/
