/* 
    BOOLEAN
        ...
        - a boolean has two possible values of eithe true or false
*/
...
let first = 1050 + 100; // computation
...
/*
    - when javascript sees that we're trying to add together a number and a string, instead of using the built in
    math functionality, it will instead use concatenation to combine the values instead of trying to synthesize them
*/
...
let lastName = "Jones";
let houseNumber = "8388";
let street = "Lancaster Dr.";
let city = "Newburgh";
let state = "IN";
let zipcode = "47630";
